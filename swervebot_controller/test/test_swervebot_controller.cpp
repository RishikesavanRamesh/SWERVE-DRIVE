...
#include "test_swervebot_controller.hpp"
...
using swervebot_controller::CMD_MY_ITFS;
using swervebot_controller::control_mode_type;
using swervebot_controller::STATE_MY_ITFS;

class SwervebotControllerTest : public SwervebotControllerFixture<TestableSwervebotController>
{
};

TEST_F(SwervebotControllerTest, all_parameters_set_configure_success)
{
  SetUpController();
...
TEST_F(SwervebotControllerTest, check_exported_intefaces)
{
  SetUpController();
...
TEST_F(SwervebotControllerTest, activate_success)
{
  SetUpController();
...
TEST_F(SwervebotControllerTest, update_success)
{
  SetUpController();
...
TEST_F(SwervebotControllerTest, deactivate_success)
{
  SetUpController();
...
TEST_F(SwervebotControllerTest, reactivate_success)
{
  SetUpController();
...
TEST_F(SwervebotControllerTest, test_setting_slow_mode_service)
{
  SetUpController();
...
TEST_F(SwervebotControllerTest, test_update_logic_fast)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
...
TEST_F(SwervebotControllerTest, test_update_logic_slow)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
...
TEST_F(SwervebotControllerTest, publish_status_success)
{
  SetUpController();
...
TEST_F(SwervebotControllerTest, receive_message_and_publish_updated_status)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
